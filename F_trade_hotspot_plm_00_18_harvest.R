...
F.trade <- read.csv("F_trade_hotspot_00_18_input_harvest.csv", header=T, stringsAsFactors=FALSE)
...
########################################################
# The number of tourists shows a presence of heteroskedasitcity. We need to controll that.
coeftest(plm.random)
